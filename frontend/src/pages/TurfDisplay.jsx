...
const TurfDisplay = () => {
  ...
  const { title: name, city, photo: image, price, reviews, maxGroupSize, distance, desc } = tour;


  return (
    <div
      className="md:w-1/2 h-64"
      style={{
      ...
      <div className="container mx-auto p-4 turf-container">
          ...
          <div className="md:w-1/2 md:pl-8 mt-4 md:mt-0">
            ...
            <h3 className="text-2xl font-semibold text-white mb-4">
              ₹{price} <span className="text-lg text-white font-normal">/per hour</span>
            </h3>
            <button
              className='book-btn'
